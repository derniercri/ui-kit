...
module.exports = plop => {
  ...
  plop.setGenerator('hook', {
    ...
    plop.setGenerator('pure', {
      description: 'Create a reusable pure component',
      prompts: [
        {
          type: 'input',
          name: 'name',
      ...
      actions: [
        {
          type: 'add',
          path: 'src/components/{{pascalCase name}}/{{pascalCase name}}.js',
          templateFile: 'plop-templates/Pure/Component.js.hbs',
        },
        {
          type: 'add',
          path: 'src/components/{{pascalCase name}}/{{pascalCase name}}.test.js',
          templateFile: 'plop-templates/Pure/Component.test.js.hbs',
        },
        {
          type: 'add',
          path: 'src/components/{{pascalCase name}}/{{pascalCase name}}.module.css',
          templateFile: 'plop-templates/Pure/Component.module.css.hbs',
        },
        {
          type: 'add',
          path: 'src/components/{{pascalCase name}}/index.js',
          templateFile: 'plop-templates/Pure/index.js.hbs',
        },
        {
          type: 'add',
          path: 'src/components/index.js',
